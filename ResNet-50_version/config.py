...
# parser.add_argument('--training_path', type=str, default='/media/circle/SeagateExp/data_sod/RGB_Dataset/train/DUTS/')
parser.add_argument('--training_path', type=str, default='/raid/datasets/data_sod/RGB_Dataset/train/DUTS/')
...
if param['task'] == 'SOD':
    ...
    param['test_dataset_root'] = 'D:/Code/Data/data_sod/RGB_Dataset/test/img/'
    # param['test_dataset_root'] = '/raid/datasets/data_sod/RGB_Dataset/test/img/'
