...
task = "SOD"
if task == "SOD":
    # gt_dir = "/media/data1/data_sod/RGB_Dataset/gt/"

    # gt_dir = "/media/circle/SeagateExp/data_sod/RGB_Dataset/gt/"
    gt_dir = "/raid/datasets/data_sod/RGB_Dataset/gt/"
